...
class GameConsumer(AsyncWebsocketConsumer):
    ...
    async def connect(self):
        ...
        print("\n\n===========")
        print(f"User {self.scope['user']} connected to game {self.game_id} in group {self.room_group_name}")
    ...
    async def disconnect(self, close_code):
        ...
        print("\n\n===========")
        print(f"User {self.scope['user']} disconnected from game {self.game_id} in group {self.room_group_name}")
    ...
    async def send_start_game(self):
        ...
        print(f"Sending 'Game starting!' to group {self.room_group_name} for game {self.game_id}")
